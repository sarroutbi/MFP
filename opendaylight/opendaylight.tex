...
Up to this point, EPLv1.0 and OpenDaylight Open Source project to use this license have been analysed. In next section, other legal considerations will be studied in order to clarify other important issues that are considered inside OpenDaylight Open Source project to be important as well.

\section{Other Legal Considerations}

Other Legal Considerations: Rewrite them
...
17. Will the products developed on the framework also be open source?
...
NOTE: Bylaw: (Estatutos)
NOTE2: Adopted July 28, 2014
Analyze documents and other stuff under:
http://www.opendaylight.org/project/bylaws
...
\chapter{OpenDaylight: Community Management and Governance}
